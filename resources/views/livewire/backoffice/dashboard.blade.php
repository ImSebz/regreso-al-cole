                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <a href="{{ asset("storage/$foto_portada") }}" target="_blank">
                                            <img src="{{ asset("storage/$foto_portada") }}" height="250" width="250">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select wire:model.change="aprobacion_portada" name="" id="" class="form-control">
                ...
                <div class="card my-2">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <button wire:click="getRegistro({{ $RegistroFactura->id }})" class="btn btn-primary"> Ver mas </button>
                            </div>
                        </div>
                    </div>
                </div>
